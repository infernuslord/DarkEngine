// $Header: x:/prj/tech/libsrc/ui/RCS/texttool.h 1.7 1998/06/18 13:29:56 JAEMZ Exp $
...
// prototypes
EXTERN TextTool *tt_full_build(TTRect *pos, TTState *es, TTFontInfo *ttf, void *output_data, char *keymap,
   void (*d_func)(void *, Rect *));
#define tt_easy_build() tt_full_build(NULL,NULL,NULL,NULL,NULL)
EXTERN bool tt_toast(TextTool *old_tt);
EXTERN bool tt_set(TextTool *def_tt);
EXTERN long tt_parse_char(TextTool *tt, ushort key_code);
EXTERN long tt_parse_string(TextTool *tt, char *st);
EXTERN char *tt_get(TextTool *tt, long line_num);
EXTERN void tt_dump(TextTool *tt);
EXTERN void tt_display_all(TextTool *tt, Rect *r);
EXTERN void tt_show_all(TextTool *tt);
EXTERN void tt_move(TextTool *tt, int xoff, int yoff);
EXTERN void tt_fill_line(TextTool *tt, int how, long line_num, char *s);
#endif
