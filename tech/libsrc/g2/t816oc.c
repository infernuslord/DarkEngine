// $Header: x:/prj/tech/libsrc/g2/RCS/t816oc.c 1.2 1998/04/28 14:29:38 KEVIN Exp $
#include <trirast.h>
#include <plyshell.h>
#include <genrast.h>
#include <tmapd.h>
...
static void trans_8to16_check_occlusion_inner_loop(g2s_raster *r, g2s_poly_params *tp)
{
   fix u,v;
   int x;
   ushort *dst;

   dst = ((ushort *)r->p) + r->x + r->n;
   x = -r->n;
   u = r->u;
   v = r->v;
...
fix trans_8to16_check_occlusion_umap(grs_bitmap *bm, int n, g2s_point **vpl)
{
   ...
   g2d_pp.u_scale = bm->w;
   g2d_pp.v_scale = bm->h;
   g2d_pp.inner_loop = trans_8to16_check_occlusion_inner_loop;
