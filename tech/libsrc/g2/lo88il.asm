; $Header: x:/prj/tech/libsrc/g2/RCS/lo88il.asm 1.2 1998/04/09 10:01:30 KEVIN Exp $
...
;      edx = num scanlines
_FUNCDEF opaque_lit_8to8_raster, 2
        push    ebp
        mov     ebp, eax
...
p_src:
        ...
        mov     dl, 0deadbeefh[edx]     ; read from ltab
ltab:
...
;takes eax = bitmap
_FUNCDEF opaque_lit_8to8_il_init, 1
        push    esi
        push    edi
