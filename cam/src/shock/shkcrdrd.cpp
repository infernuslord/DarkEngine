////////////////////////////////////////////
//
// $Header: r:/t2repos/thief2/src/shock/shkcrdrd.cpp,v 1.5 1999/04/20 18:10:44 JON Exp $
//
...
static sCrPhysModOffset g_aDroidPhysModOffsets[] = \
{
   { 8, 8, 0.0, 1.95},
   { 9, 10, 0.7, 1.95},
};
...
static int g_aDroidJointParents[] =
{
LANKLE,  // LTOE
RANKLE,  // RTOE     
LKNEE,   // LANKLE    
...
const sCreatureDesc sCrDroidDesc = \
{
     kShATYPE_Droid, // actor type
     2,         // num torsos
     5,         // num limbs
     18,        // num joints
     "mainbot", // default lengths filename
     2,                    // number of phys models
     1, // default phys radius
     g_aDroidPhysModOffsets, // array of phys model offsets
     g_aDroidJointParents,   // joint parent mapping
     g_aDroidJointMap,
     2,         // num feet
