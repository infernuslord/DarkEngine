///////////////////////////////////////////////////////////////////////////////
// $Header: r:/t2repos/thief2/src/shock/shkflash.cpp,v 1.8 1999/11/19 14:54:21 adurant Exp $
//
// gun flashes
//

This file has been moved to shkflash.cpp AMSD
   ...
   while (!pFlashQuery->Done())
   {
      ...
      if ((pData->m_flags)&kFlashProjectile)
      {
         ...
         if (!isGhost)
         {
            ...
            newID = ShockLaunchProjectile(PlayerObject(), 
                                          pFlashQuery.GetDest(),
                                          &launchParams);
         }
      }
