////////////////////////////////////////////
// $Header: r:/t2repos/thief2/src/shock/shkcrmky.cpp,v 1.4 1999/08/24 14:21:58 ccarollo Exp $
//
...
static sCrPhysModOffset g_aMonkeyPhysModOffsets[] = \
{
   { 8, 8, 0.0, 0.5},
   { 18, 9, 0.5, 0.5},
};
...
static int g_aMonkeyJointParents[] =
{
   LANKLE,   //    LTOE    
   RANKLE,   //    RTOE    
   LKNEE,    //    LANKLE  
...
const sCreatureDesc sCrMonkeyDesc = \
{
     ...
     0.5, // default phys radius
     g_aMonkeyPhysModOffsets, // array of phys model offsets
     g_aMonkeyJointParents,   // joint parent mapping
     g_aMonkeyJointMap,
     2,         // num feet
