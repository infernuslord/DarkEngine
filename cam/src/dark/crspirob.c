...
static int g_aSpiderBotJointMap[] = 
{
   -1,
    0, // head
   -1,
...
static int g_aSpiderBotJointParents[] =
{
   base,    //  base   
   base,    //  lmand  
   lmand,   //  lmelbow
...
const sCreatureDesc sCrSpiderBotDesc = \
{
     kDATYPE_Spider, // actor type
     4,        // num torsos
     10,       // num limbs
     40,        // num joints
     "robotspj",  // default lengths filename
     ...
     g_aSpiderBotJointParents,   // joint parent mapping
     g_aSpiderBotJointMap,
