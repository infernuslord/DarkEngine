////////////////////////////////////////////////////////////////////////////////
// $Header: r:/t2repos/thief2/src/dark/crjoint.h,v 1.6 2000/01/31 09:39:39 adurant Exp $
//
...
#ifdef __cplusplus
EXTERN mxs_vector &GetCreatureJointPos(ObjID creature, int joint);
EXTERN mxs_matrix &GetCreatureJointOrient(ObjID creature, int joint);
#endif
