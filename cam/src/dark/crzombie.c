// $Header: r:/t2repos/thief2/src/dark/crzombie.c,v 1.4 1998/10/23 01:49:18 CCAROLLO Exp $
...
const sCreatureDesc sCrZombieDesc = \
{
     kDATYPE_Humanoid, // actor type
     2,         // num torsos
     5,         // num limbs
     20,        // num joints
     "expzom",  // default lengths filename
     2,                    // number of phys models
     HUMANOID_PHYS_RADIUS, // default phys radius
     g_aZomPhysModOffsets, // array of phys model offsets
     g_aZomJointParents,   // joint parent mapping
     g_aZomJointMap,
     2,         // num feet
