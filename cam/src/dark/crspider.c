// $Header: r:/t2repos/thief2/src/dark/crspider.c,v 1.11 1998/10/23 01:49:15 CCAROLLO Exp $
...
#define SPIDER_LEG_PHYS_RADIUS 0.3
...
const sCreatureDesc sCrSpiderDesc = \
{
     kDATYPE_Spider, // actor type
     4,        // num torsos
     10,       // num limbs
     39,        // num joints
     "spidey7",  // default lengths filename
