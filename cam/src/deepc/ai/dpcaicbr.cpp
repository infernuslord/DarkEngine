...
STDMETHODIMP_(void) cAIDPCRangedSubcombat::Init()
{
   cAISubcombat::Init();
   ...
   m_pModes[m_numberModes++] = new cAIDPCRangedBackup(this);
...
///////////////////////////////////////////////////////
//
// Deep Cover physcast callback for ranged combat ability
//

BOOL DPCRangedPhyscastCallback(ObjID objID, const cPhysModel* pModel, sAIRangedCombatPhyscastData* pData)
{
