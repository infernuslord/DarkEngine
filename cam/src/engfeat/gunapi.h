...
// Condition
EXTERN float GunGetSilencing(ObjID gunID);
EXTERN void GunSetSilencing(ObjID gunID, float silenceness);
EXTERN void GunGetSilencingString(ObjID gunID, char *buf, int buflen);
